...
const LatestNews = () => {
  ...
  useEffect(() => {
    fetch(
      "https://newsapi.org/v2/everything?q=health%20OR%20صحة&language=ar&sortBy=publishedAt&apiKey=d448329812b944a59b7061f6b8508e00"
    )
      .then((res) => res.json())
  ...
  return (
    <div className="LatestNews py-5 bg-light pb-5">
      <div className="container">
        ...
        >
          {/* Card 1 */}
          {news.map((lastnews, index) => (
            <div className="col-lg-4 col-md-6 col-sm-12 mb-4" key={index}>
              <div
                className=" text-center card shadow-sm border-1 p-0"
                style={{
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
